...
use polkaregistry_runtime::Block;
...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/polkaregistry/parachain/issues/new".into()
	}
